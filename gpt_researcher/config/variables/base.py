...
class BaseConfig(TypedDict):
    ...
    RETRIEVER_PRIORITY_MODE: str
    MEDICAL_TIME_WINDOW_YEARS: int
    TAVILY_EFFICIENCY_MODE: bool
    TAVILY_SOFT_FALLBACK: bool
    DOMAIN_TIER0: str
    DOMAIN_TIER1: str
    DOMAIN_TIER2: str
    MIN_UNIQUE_SOURCES: int
    RERANK_EXPLAIN_LOG_MODE: str
    RERANK_EXPLAIN_SCOPE: int
    MEMORY_BACKEND: str
    TOTAL_WORDS: int
    REPORT_FORMAT: str
    CURATE_SOURCES: bool
